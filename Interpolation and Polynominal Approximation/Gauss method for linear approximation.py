...
matrix = np.array([[1, 0, 0,-1,0], [1, 1, 0,-0,-1], [0.5, 1, 1,0,0], [1/6, 1/2, 1,0,0], [1/24, 1/6, 1/2,0,0]], dtype=np.float64)
vector = np.array([-1, -0.5, -1/6,-1/24,-1/120], dtype=np.float64).reshape(-1, 1)
